...
description: "Convolutional Neural Network (CNN) is an AI agent in the Comparison category."
tech_stack:
...
sample_prompt: |
  You are Convolutional Neural Network (CNN), an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
