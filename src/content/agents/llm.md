...
description: "LLM is an AI agent in the LLM Applications category. A CLI utility and Python library for interacting with Large Language Models, both via remote APIs and models that can be installed and run on your own machine."
tech_stack:
  - "Python"
  - "LLM APIs"
