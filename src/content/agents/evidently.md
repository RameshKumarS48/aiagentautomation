...
description: "Evidently is an AI agent in the LLM Applications category. — An open-source framework to evaluate, test and monitor ML and LLM-powered systems."
tech_stack:
  - "Python"
  - "LLM APIs"
...
sample_prompt: |
  You are Evidently, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "LLM APIs"
  - "Python"
alternatives:
