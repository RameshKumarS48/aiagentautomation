...
description: "tabnine is an AI agent in the Code category. Code faster with whole-line & full-function code completions."
tech_stack:
...
sample_prompt: |
  You are tabnine, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
