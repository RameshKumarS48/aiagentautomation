...
source_url: "https://github.com/pytorch/serve"
description: "TorchServe is an AI agent in the Deployment and Serving category. ![](https://img.shields.io/github/stars/pytorch/serve.svg?cacheSeconds=86400) - TorchServe is a flexible and easy to use tool for serving PyTorch models."
tech_stack:
  - "Python"
  - "LLM APIs"
...
sample_prompt: |
  You are TorchServe, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "LLM APIs"
  - "Python"
alternatives:
