...
source_url: "https://github.com/Dicklesworthstone/swiss_army_llama"
description: "Swiss Army Llama is an AI agent in the LLM Applications category. Comprehensive set of tools for working with local LLMs for various tasks."
tech_stack:
  - "Python"
  - "LLM APIs"
...
sample_prompt: |
  You are Swiss Army Llama, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "LLM APIs"
  - "Python"
alternatives:
