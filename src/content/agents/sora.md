...
description: "Sora is an AI agent in the Milestones category. Presentation of Sora, a large video generation model. OpenAI, February 15, 2024."
tech_stack:
  - "Not publicly specified"
problem_solved: "This tool addresses challenges in the milestones domain."
target_audience: "Developers and teams working with milestones automation."
inputs:
  - "User configuration"
...
sample_prompt: |
  You are Sora, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
