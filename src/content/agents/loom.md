...
description: "Loom is an AI agent in the Video category. Seamless screen, mic, and camera recording for Chrome"
tech_stack:
...
sample_prompt: |
  You are Loom, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
