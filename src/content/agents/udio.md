...
description: "Udio is an AI agent in the Music category. Discover, create, and share music with the world."
tech_stack:
...
sample_prompt: |
  You are Udio, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
