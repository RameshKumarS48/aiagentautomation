...
description: "Berkeley Function-Calling Leaderboard is an AI agent in the LLM Leaderboard category. evaluates LLM's ability to call external functions/tools."
tech_stack:
...
sample_prompt: |
  You are Berkeley Function-Calling Leaderboard, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
