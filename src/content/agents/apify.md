...
description: "APIFY is an AI agent in the Data  Scraping category. Extract data from any website"
tech_stack:
...
sample_prompt: |
  You are APIFY, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
