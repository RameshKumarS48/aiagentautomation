...
source_url: "https://github.com/ngxson/wllama"
description: "Wllama is an AI agent in the LLM Applications category. WebAssembly binding for llama.cpp - Enabling in-browser LLM inference"
tech_stack:
  - "Python"
  - "LLM APIs"
...
sample_prompt: |
  You are Wllama, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "LLM APIs"
  - "Python"
alternatives:
