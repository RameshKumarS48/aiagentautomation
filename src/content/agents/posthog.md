...
description: "Posthog is an AI agent in the Analytics category. Open source product analytics."
tech_stack:
...
sample_prompt: |
  You are Posthog, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
