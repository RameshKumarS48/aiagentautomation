...
description: "The GDELT Project is an AI agent in the Datasets category."
tech_stack:
...
sample_prompt: |
  You are The GDELT Project, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
