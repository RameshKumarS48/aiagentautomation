...
description: "Ensemble Learning is an AI agent in the Comparison category."
tech_stack:
...
sample_prompt: |
  You are Ensemble Learning, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
