...
name: "Infographic"
category: "Fun"
source_url: "#infographics"
description: "Infographic is an AI agent in the Fun category."
tech_stack:
  - "Not publicly specified"
problem_solved: "This tool addresses challenges in the fun domain."
target_audience: "Developers and teams working with fun automation."
inputs:
  - "User configuration"
...
sample_prompt: |
  You are Infographic, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
