...
source_url: "https://github.com/fuergaosi233/wechat-chatgpt"
description: "wechat-chatgpt is an AI agent in the LLM Applications category. Use ChatGPT On Wechat via wechaty"
tech_stack:
  - "Python"
  - "LLM APIs"
...
sample_prompt: |
  You are wechat-chatgpt, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "LLM APIs"
  - "Python"
alternatives:
