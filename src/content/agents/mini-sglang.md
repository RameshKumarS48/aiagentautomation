...
description: "mini-sglang is an AI agent in the Deployment and Serving category. ![](https://img.shields.io/github/stars/sgl-project/mini-sglang.svg?cacheSeconds=86400) - mini-sglang is a lightweight and efficient serving framework for large language models."
tech_stack:
  - "Python"
  - "LLM APIs"
...
sample_prompt: |
  You are mini-sglang, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "LLM APIs"
  - "Python"
alternatives:
