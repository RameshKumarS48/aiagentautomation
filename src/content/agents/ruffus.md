...
description: "Ruffus is an AI agent in the Python category. Computation Pipeline library for python."
tech_stack:
...
sample_prompt: |
  You are Ruffus, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
