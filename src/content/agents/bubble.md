...
description: "Bubble is an AI agent in the Web Apps category. Build production-ready web apps."
tech_stack:
...
sample_prompt: |
  You are Bubble, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
