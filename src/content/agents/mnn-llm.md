...
description: "MNN-LLM is an AI agent in the LLM Applications category. A Device-Inference framework, including LLM Inference on device(Mobile Phone/PC/IOT)"
tech_stack:
  - "Python"
  - "LLM APIs"
...
sample_prompt: |
  You are MNN-LLM, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "LLM APIs"
  - "Python"
alternatives:
