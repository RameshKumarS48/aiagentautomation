...
description: "Dataconomy is an AI agent in the Bloggers category. A blog on the newly emerging data economy"
tech_stack:
...
sample_prompt: |
  You are Dataconomy, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
