...
source_url: "https://github.com/meta-pytorch/torchtune"
description: "torchtune is an AI agent in the Deployment and Serving category. ![](https://img.shields.io/github/stars/meta-pytorch/torchtune.svg?cacheSeconds=86400) - torchtune is a PyTorch library for easily authoring, post-training, and experimenting with LLMs."
tech_stack:
  - "Python"
  - "LLM APIs"
...
sample_prompt: |
  You are torchtune, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "LLM APIs"
  - "Python"
alternatives:
