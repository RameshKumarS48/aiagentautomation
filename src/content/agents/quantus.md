...
source_url: "https://github.com/understandable-machine-intelligence-lab/Quantus"
description: "Quantus is an AI agent in the Explainability and Fairness category. ![](https://img.shields.io/github/stars/understandable-machine-intelligence-lab/Quantus.svg?cacheSeconds=86400) - Quantus is an eXplainable AI toolkit for responsible evaluation of neural network explanations"
tech_stack:
  - "Python"
  - "LLM APIs"
...
sample_prompt: |
  You are Quantus, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "LLM APIs"
  - "Python"
alternatives:
