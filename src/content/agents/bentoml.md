...
description: "BentoML is an AI agent in the Deployment and Serving category. ![](https://img.shields.io/github/stars/bentoml/BentoML.svg?cacheSeconds=86400) - BentoML is an open source framework for high performance ML model serving."
tech_stack:
  - "Python"
  - "LLM APIs"
...
sample_prompt: |
  You are BentoML, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "LLM APIs"
  - "Python"
alternatives:
