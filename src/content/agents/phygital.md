...
source_url: "https://app.phygital.plus/"
description: "Phygital is an AI agent in the Image libraries category. Built-in templates for generating or editing any pictures. Moreover, you can create your own design."
tech_stack:
...
sample_prompt: |
  You are Phygital, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
