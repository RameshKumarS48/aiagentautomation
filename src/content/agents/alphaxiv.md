...
description: "alphaXiv is an AI agent in the Academia category. Discuss, discover, and read arXiv papers."
tech_stack:
...
sample_prompt: |
  You are alphaXiv, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
