...
description: "Google Dataset Search is an AI agent in the Datasets category. Find datasets across the web."
tech_stack:
...
sample_prompt: |
  You are Google Dataset Search, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
