...
source_url: "https://github.com/LazyAGI/LazyLLM"
description: "LazyLLM is an AI agent in the LLM Applications category. An open-source LLM app for building multi-agent LLMs applications in an easy and lazy way, supports model deployment and fine-tuning."
tech_stack:
  - "Python"
  - "LLM APIs"
