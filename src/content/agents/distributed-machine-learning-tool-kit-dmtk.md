...
sample_prompt: |
  You are Distributed Machine learning Tool Kit (DMTK), an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
