...
source_url: "https://github.com/epsilla-cloud"
description: "Epsilla is an AI agent in the LLM Applications category. An all-in-one LLM Agent platform with your private data and knowledge, delivers your production-ready AI Agents on Day 1."
tech_stack:
  - "Python"
  - "LLM APIs"
...
sample_prompt: |
  You are Epsilla, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "LLM APIs"
  - "Python"
alternatives:
