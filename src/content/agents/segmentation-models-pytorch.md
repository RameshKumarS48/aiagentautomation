...
sample_prompt: |
  You are segmentation_models.pytorch, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "LLM APIs"
  - "Python"
alternatives:
