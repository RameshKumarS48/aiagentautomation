...
description: "Civitai is an AI agent in the Model libraries category. Community-driven AI model sharing tool."
tech_stack:
...
sample_prompt: |
  You are Civitai, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
