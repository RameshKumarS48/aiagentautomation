...
source_url: "https://github.com/SJTU-IPADS/PowerInfer"
description: "PowerInfer is an AI agent in the Deployment and Serving category. ![](https://img.shields.io/github/stars/SJTU-IPADS/PowerInfer.svg?cacheSeconds=86400) - PowerInfer is a CPU/GPU LLM inference engine leveraging activation locality for your device."
tech_stack:
  - "Python"
  - "LLM APIs"
...
sample_prompt: |
  You are PowerInfer, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "LLM APIs"
  - "Python"
alternatives:
