...
description: "SHAPash is an AI agent in the Explainability and Fairness category. ![](https://img.shields.io/github/stars/MAIF/shapash.svg?cacheSeconds=86400) - Shapash is a Python library that provides several types of visualization that display explicit labels that everyone can understand."
tech_stack:
  - "Python"
  - "LLM APIs"
...
sample_prompt: |
  You are SHAPash, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "LLM APIs"
  - "Python"
alternatives:
