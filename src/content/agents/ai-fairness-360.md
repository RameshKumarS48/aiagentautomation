...
source_url: "https://github.com/Trusted-AI/AIF360"
description: "AI Fairness 360 is an AI agent in the Explainability and Fairness category. ![](https://img.shields.io/github/stars/Trusted-AI/AIF360.svg?cacheSeconds=86400) - A comprehensive set of fairness metrics for datasets and machine learning models, explanations for these metrics, and algorithms to mitigate bias in datasets and models."
tech_stack:
  - "Python"
  - "LLM APIs"
...
sample_prompt: |
  You are AI Fairness 360, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "LLM APIs"
  - "Python"
alternatives:
