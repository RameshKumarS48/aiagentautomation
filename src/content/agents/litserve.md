...
description: "LitServe is an AI agent in the Deployment and Serving category. ![](https://img.shields.io/github/stars/Lightning-AI/LitServe.svg?cacheSeconds=86400) - LitServe is a flexible serving engine for AI models built on FastAPI. It supports custom inference engines for models, agents, multi-modal systems, RAG, and complex ML pipelines."
tech_stack:
  - "Python"
  - "LLM APIs"
...
sample_prompt: |
  You are LitServe, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "LLM APIs"
  - "Python"
alternatives:
