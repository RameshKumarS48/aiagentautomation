...
source_url: "https://phoenix.arize.com/"
description: "Arize-Phoenix is an AI agent in the LLM Applications category. Open-source tool for ML observability that runs in your notebook environment. Monitor and fine tune LLM, CV and Tabular Models."
tech_stack:
...
sample_prompt: |
  You are Arize-Phoenix, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
