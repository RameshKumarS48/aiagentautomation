...
source_url: "https://github.com/reid41/QA-Pilot"
description: "QA-Pilot is an AI agent in the LLM Applications category. An interactive chat project that leverages Ollama/OpenAI/MistralAI LLMs for rapid understanding and navigation of GitHub code repository or compressed file resources."
tech_stack:
  - "Python"
  - "LLM APIs"
...
sample_prompt: |
  You are QA-Pilot, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "LLM APIs"
  - "Python"
alternatives:
