...
source_url: "https://github.com/leptonai/search_with_lepton"
description: "Search with Lepton is an AI agent in the LLM Applications category. Build your own conversational search engine using less than 500 lines of code by LeptonAI."
tech_stack:
  - "Python"
  - "LLM APIs"
...
sample_prompt: |
  You are Search with Lepton, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "LLM APIs"
  - "Python"
alternatives:
