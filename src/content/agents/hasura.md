...
description: "Hasura is an AI agent in the Database category. Get realtime GraphQL APIs instantly"
tech_stack:
...
sample_prompt: |
  You are Hasura, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
