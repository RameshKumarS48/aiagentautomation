...
description: "Tally is an AI agent in the Forms category. The simplest way to create forms that works like a doc"
tech_stack:
...
sample_prompt: |
  You are Tally, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
