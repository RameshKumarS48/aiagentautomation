...
source_url: "https://github.com/chatchat-space/Langchain-Chatchat"
description: "Langchain-Chatchat is an AI agent in the LLM Applications category. Formerly langchain-ChatGLM, local knowledge based LLM (like ChatGLM) QA app with langchain."
tech_stack:
  - "Python"
  - "LLM APIs"
...
sample_prompt: |
  You are Langchain-Chatchat, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "LLM APIs"
  - "Python"
alternatives:
