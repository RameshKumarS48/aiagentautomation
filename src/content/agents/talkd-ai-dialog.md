...
source_url: "https://github.com/talkdai/dialog"
description: "talkd.ai dialog is an AI agent in the LLM Applications category. Simple API for deploying any RAG or LLM that you want adding plugins."
tech_stack:
  - "Python"
  - "LLM APIs"
...
sample_prompt: |
  You are talkd.ai dialog, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "LLM APIs"
  - "Python"
alternatives:
