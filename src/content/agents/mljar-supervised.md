...
source_url: "https://github.com/mljar/mljar-supervised"
description: "mljar-supervised is an AI agent in the Explainability and Fairness category. ![](https://img.shields.io/github/stars/mljar/mljar-supervised.svg?cacheSeconds=86400) - A Python package for AutoML on tabular data with feature engineering, hyper-parameters tuning, explanations and automatic documentation."
tech_stack:
  - "Python"
  - "LLM APIs"
