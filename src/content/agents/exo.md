...
description: "exo is an AI agent in the Deployment and Serving category. ![](https://img.shields.io/github/stars/exo-explore/exo.svg?cacheSeconds=86400) - exo helps you run your AI cluster at home with everyday devices."
tech_stack:
  - "Python"
  - "LLM APIs"
...
sample_prompt: |
  You are exo, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "LLM APIs"
  - "Python"
alternatives:
