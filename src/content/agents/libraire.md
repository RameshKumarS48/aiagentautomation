...
source_url: "https://libraire.ai/"
description: "Libraire is an AI agent in the Image libraries category. The largest library of AI-generated images."
tech_stack:
...
sample_prompt: |
  You are Libraire, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
