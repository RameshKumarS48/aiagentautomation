...
description: "unDraw is an AI agent in the Design category. Free, open-source illustrations for every project."
tech_stack:
...
sample_prompt: |
  You are unDraw, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
