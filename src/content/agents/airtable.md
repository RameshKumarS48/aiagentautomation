...
description: "Airtable is an AI agent in the Database category. Database / Spreadsheet mashup"
tech_stack:
...
sample_prompt: |
  You are Airtable, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
