...
description: "Google Analytics is an AI agent in the Analytics category. Free website analytics."
tech_stack:
...
sample_prompt: |
  You are Google Analytics, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
