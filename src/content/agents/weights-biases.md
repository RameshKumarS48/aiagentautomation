...
source_url: "https://wandb.ai/site/solutions/llmops"
description: "Weights & Biases is an AI agent in the LLM Applications category. — A paid product for tracking model training and prompt engineering experiments."
tech_stack:
...
sample_prompt: |
  You are Weights & Biases, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
