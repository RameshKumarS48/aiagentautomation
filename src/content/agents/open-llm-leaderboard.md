...
description: "Open LLM Leaderboard is an AI agent in the LLM Leaderboard category. aims to track, rank, and evaluate LLMs and chatbots as they are released."
tech_stack:
...
sample_prompt: |
  You are Open LLM Leaderboard, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
