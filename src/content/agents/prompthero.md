...
source_url: "https://prompthero.com/"
description: "PromptHero is an AI agent in the Image libraries category. Search prompts for models like Stable Diffusion, ChatGPT, Midjourney, etc."
tech_stack:
...
sample_prompt: |
  You are PromptHero, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
