...
source_url: "https://chat.openai.com/g/g-VQihKqtCa-cloud-guardian"
description: "Cloud Guardian is an AI agent in the Cybersecurity GPTs category. ): Is your Cloud Security AI Assistant to help you do your cloud security job better and learn new cloud knowledge from our training data which is the transcript of interviews from [Cloud Security Podcast](https://www.cloudsecuritypodcast.tv/) [Github here for Training Data which you can contribute to as well.](https://github.com/hashishrajan/CloudGuardian)?"
tech_stack:
...
sample_prompt: |
  You are Cloud Guardian, an AI assistant specialized in cybersecurity gpts. Help the user accomplish their task efficiently and accurately.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
