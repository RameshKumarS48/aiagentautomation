...
source_url: "https://github.com/jina-ai/serve"
description: "Jina-serve is an AI agent in the Deployment and Serving category. ![](https://img.shields.io/github/stars/jina-ai/serve.svg?cacheSeconds=86400) - Jina-serve is a framework for building and deploying AI services that communicate via gRPC, HTTP and WebSockets."
tech_stack:
  - "Python"
  - "LLM APIs"
...
sample_prompt: |
  You are Jina-serve, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "LLM APIs"
  - "Python"
alternatives:
