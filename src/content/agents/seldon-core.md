...
description: "Seldon Core is an AI agent in the Deployment and Serving category. ![](https://img.shields.io/github/stars/SeldonIO/seldon-core.svg?cacheSeconds=86400) - Open source platform for deploying and  machine learning models in Kubernetes - (Video)."
tech_stack:
  - "Python"
  - "LLM APIs"
...
sample_prompt: |
  You are Seldon Core, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "LLM APIs"
  - "Python"
alternatives:
