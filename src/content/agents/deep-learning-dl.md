...
category: "General"
source_url: "#DL"
description: "Deep Learning(DL) is an AI agent in the General category."
tech_stack:
...
sample_prompt: |
  You are Deep Learning(DL), an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
