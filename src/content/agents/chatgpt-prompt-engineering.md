...
description: "ChatGPT Prompt Engineering is an AI agent in the LLM Tutorials and Courses category."
tech_stack:
...
sample_prompt: |
  You are ChatGPT Prompt Engineering, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
