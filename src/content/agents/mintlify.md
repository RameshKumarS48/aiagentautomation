...
description: "Mintlify is an AI agent in the Code category. AI powered documentation writer."
tech_stack:
...
sample_prompt: |
  You are Mintlify, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
