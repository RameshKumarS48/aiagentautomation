...
description: "Dive into Deep Learning is an AI agent in the Books category."
tech_stack:
...
sample_prompt: |
  You are Dive into Deep Learning, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
