...
description: "Julia Evans is an AI agent in the Bloggers category. Recurse Center alumna"
tech_stack:
...
sample_prompt: |
  You are Julia Evans, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
