...
source_url: "https://github.com/longevity-genie/just-chat"
description: "Just-Chat is an AI agent in the LLM Applications category. Make your LLM agent and chat with it simple and fast!"
tech_stack:
  - "Python"
  - "LLM APIs"
...
sample_prompt: |
  You are Just-Chat, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "LLM APIs"
  - "Python"
alternatives:
