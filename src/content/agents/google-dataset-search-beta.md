---
name: "Google Dataset Search (beta)"
category: "Datasets"
source_url: "https://datasetsearch.research.google.com/"
description: "Google Dataset Search (beta) is an AI agent in the Datasets category."
tech_stack:
...
sample_prompt: |
  You are Google Dataset Search (beta), an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
