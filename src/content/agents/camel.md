...
description: "CAMEL is an AI agent in the LLM Applications category. First LLM Multi-agent framework."
tech_stack:
...
sample_prompt: |
  You are CAMEL, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
