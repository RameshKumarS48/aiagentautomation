...
description: "OpenClaw Wikipedia is an AI agent in the Origins  History category. Wikipedia"
tech_stack:
...
sample_prompt: |
  You are OpenClaw Wikipedia, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
