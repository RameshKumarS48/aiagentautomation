...
description: "OpenAI Evals is an AI agent in the LLM Applications category. — An open-source library for evaluating task performance of language models and prompts."
tech_stack:
  - "Python"
  - "LLM APIs"
