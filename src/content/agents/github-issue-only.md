...
description: "GitHub (Issue Only) is an AI agent in the Links category."
tech_stack:
  - "Python"
  - "LLM APIs"
...
sample_prompt: |
  You are GitHub (Issue Only), an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "LLM APIs"
  - "Python"
alternatives:
