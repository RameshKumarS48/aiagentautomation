...
description: "Pinecone is an AI agent in the Developer tools category. Long-Term Memory for AI."
tech_stack:
...
sample_prompt: |
  You are Pinecone, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
