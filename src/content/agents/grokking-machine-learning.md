...
category: "Books"
source_url: "https://www.manning.com/books/grokking-machine-learning"
description: "Grokking Machine Learning is an AI agent in the Books category. Grokking Machine Learning teaches you how to apply ML to your projects using only standard Python code and high school-level math."
tech_stack:
...
sample_prompt: |
  You are Grokking Machine Learning, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
