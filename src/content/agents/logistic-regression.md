...
description: "Logistic Regression is an AI agent in the Comparison category."
tech_stack:
...
sample_prompt: |
  You are Logistic Regression, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
