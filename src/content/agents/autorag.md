...
description: "AutoRAG is an AI agent in the LLM Applications category. Open source AutoML tool for RAG. Optimize the RAG answer quality automatically. From generation evaluation datset to deploying optimized RAG pipeline."
tech_stack:
  - "Python"
  - "LLM APIs"
...
sample_prompt: |
  You are AutoRAG, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "LLM APIs"
  - "Python"
alternatives:
