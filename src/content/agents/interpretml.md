...
description: "InterpretML is an AI agent in the Explainability and Fairness category. ![](https://img.shields.io/github/stars/interpretml/interpret.svg?cacheSeconds=86400) - InterpretML is an open-source package for training interpretable models and explaining blackbox systems."
tech_stack:
  - "Python"
  - "LLM APIs"
...
sample_prompt: |
  You are InterpretML, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "LLM APIs"
  - "Python"
alternatives:
