...
description: "KREA is an AI agent in the Image libraries category. Explore millions of AI-generated images and create collections of prompts. Featuring Stable Diffusion generations."
tech_stack:
...
sample_prompt: |
  You are KREA, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
