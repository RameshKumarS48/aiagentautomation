...
description: "v0 is an AI agent in the UI generators category. — Create and iterate new UI components in your browser."
tech_stack:
...
sample_prompt: |
  You are v0, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
