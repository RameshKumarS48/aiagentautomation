...
source_url: "https://promptperfect.jina.ai/prompts"
description: "PromptPerfect is an AI agent in the LLM Applications category. — A paid product for testing and improving prompts."
tech_stack:
...
sample_prompt: |
  You are PromptPerfect, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
