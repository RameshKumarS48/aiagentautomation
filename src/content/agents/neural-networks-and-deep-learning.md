...
description: "Neural Networks and Deep Learning is an AI agent in the Books category."
tech_stack:
...
sample_prompt: |
  You are Neural Networks and Deep Learning, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
