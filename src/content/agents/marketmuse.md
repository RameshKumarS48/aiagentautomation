...
description: "MarketMuse is an AI agent in the Marketing AI Tools category. SEO content optimization platform using AI."
tech_stack:
...
sample_prompt: |
  You are MarketMuse, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
