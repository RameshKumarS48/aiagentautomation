...
description: "Claude Code is an AI agent in the Agents category. Anthropic's agentic coding tool."
tech_stack:
...
sample_prompt: |
  You are Claude Code, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
