...
category: "Index"
source_url: "#aws"
description: "amazon web services is an AI agent in the Index category."
tech_stack:
...
sample_prompt: |
  You are amazon web services, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
