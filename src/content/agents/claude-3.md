...
description: "Claude 3 is an AI agent in the Models category. Talk to Claude, an AI assistant from Anthropic."
tech_stack:
...
sample_prompt: |
  You are Claude 3, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
