...
description: "Lexica is an AI agent in the Image libraries category. Stable Diffusion search engine."
tech_stack:
...
sample_prompt: |
  You are Lexica, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
