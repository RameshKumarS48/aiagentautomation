...
description: "data.gov is an AI agent in the Datasets category. The home of the U.S. Government's open data"
tech_stack:
...
sample_prompt: |
  You are data.gov, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
