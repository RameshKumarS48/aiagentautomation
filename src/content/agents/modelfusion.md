...
source_url: "https://github.com/lgrammel/modelfusion"
description: "ModelFusion is an AI agent in the LLM Applications category. A TypeScript library for building apps with LLMs and other ML models (speech-to-text, text-to-speech, image generation)."
tech_stack:
  - "Python"
  - "LLM APIs"
...
sample_prompt: |
  You are ModelFusion, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "LLM APIs"
  - "Python"
alternatives:
