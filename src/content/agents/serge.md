...
source_url: "https://github.com/serge-chat/serge"
description: "Serge is an AI agent in the LLM Applications category. a chat interface crafted with llama.cpp for running Alpaca models. No API keys, entirely self-hosted!"
tech_stack:
  - "Python"
  - "LLM APIs"
...
sample_prompt: |
  You are Serge, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "LLM APIs"
  - "Python"
alternatives:
