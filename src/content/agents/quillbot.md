...
description: "QuillBot is an AI agent in the Writing assistants category. AI-powered paraphrasing tool."
tech_stack:
...
sample_prompt: |
  You are QuillBot, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
