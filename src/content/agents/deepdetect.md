...
source_url: "https://github.com/jolibrain/deepdetect"
description: "DeepDetect is an AI agent in the Deployment and Serving category. ![](https://img.shields.io/github/stars/jolibrain/deepdetect.svg?cacheSeconds=86400) - Machine Learning production server for TensorFlow, XGBoost and Cafe models written in C++ and maintained by Jolibrain."
tech_stack:
  - "Python"
  - "LLM APIs"
...
sample_prompt: |
  You are DeepDetect, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "LLM APIs"
  - "Python"
alternatives:
