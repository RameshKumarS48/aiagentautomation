...
description: "AdalFlow is an AI agent in the LLM Applications category. AdalFlow: The library to build&auto-optimize LLM applications."
tech_stack:
  - "Python"
  - "LLM APIs"
...
sample_prompt: |
  You are AdalFlow, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "LLM APIs"
  - "Python"
alternatives:
