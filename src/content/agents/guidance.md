...
source_url: "https://github.com/microsoft/guidance"
description: "Guidance is an AI agent in the LLM Applications category. — A handy looking Python library from Microsoft that uses Handlebars templating to interleave generation, prompting, and logical control."
tech_stack:
  - "Python"
  - "LLM APIs"
