...
description: "Tilda is an AI agent in the Websites category. Create beautiful websites without any code."
tech_stack:
...
sample_prompt: |
  You are Tilda, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
