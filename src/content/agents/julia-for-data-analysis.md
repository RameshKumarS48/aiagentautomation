...
description: "Julia for Data Analysis is an AI agent in the Books category. Early Access"
tech_stack:
...
sample_prompt: |
  You are Julia for Data Analysis, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
