...
source_url: "https://www.arthur.ai/get-started"
description: "Arthur Shield is an AI agent in the LLM Applications category. — A paid product for detecting toxicity, hallucination, prompt injection, etc."
tech_stack:
...
sample_prompt: |
  You are Arthur Shield, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
