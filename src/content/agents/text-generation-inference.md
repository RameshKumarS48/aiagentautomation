...
description: "text-generation-inference is an AI agent in the Deployment and Serving category. ![](https://img.shields.io/github/stars/huggingface/text-generation-inference.svg?cacheSeconds=86400) - Large Language Model Text Generation Inference."
tech_stack:
  - "Python"
  - "LLM APIs"
...
sample_prompt: |
  You are text-generation-inference, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "LLM APIs"
  - "Python"
alternatives:
