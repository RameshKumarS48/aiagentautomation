...
description: "lmsys.org is an AI agent in the LLM Leaderboard category. Benchmarking LLMs in the Wild with Elo Ratings."
tech_stack:
...
sample_prompt: |
  You are lmsys.org, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
