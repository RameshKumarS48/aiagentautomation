...
description: "Synthesia is an AI agent in the Video category. Create videos from plain text in minutes."
tech_stack:
...
sample_prompt: |
  You are Synthesia, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
