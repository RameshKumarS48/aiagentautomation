...
description: "Paypal is an AI agent in the Payments category. Send Money, Pay Online or Set Up a Merchant Account"
tech_stack:
...
sample_prompt: |
  You are Paypal, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
