...
description: "Stable Beluga 2 is an AI agent in the Models category. A finetuned LLamma2 70B model"
tech_stack:
...
sample_prompt: |
  You are Stable Beluga 2, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
