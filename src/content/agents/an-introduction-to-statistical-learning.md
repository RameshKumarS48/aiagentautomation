...
description: "An Introduction to Statistical Learning is an AI agent in the Books category. Download Page"
tech_stack:
...
sample_prompt: |
  You are An Introduction to Statistical Learning, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
