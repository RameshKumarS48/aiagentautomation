...
source_url: "https://github.com/intelligentnode/IntelliServer"
description: "IntelliServer is an AI agent in the LLM Applications category. simplifies the evaluation of LLMs by providing a unified microservice to access and test multiple AI models."
tech_stack:
  - "Python"
  - "LLM APIs"
...
sample_prompt: |
  You are IntelliServer, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "LLM APIs"
  - "Python"
alternatives:
