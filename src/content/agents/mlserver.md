...
source_url: "https://github.com/SeldonIO/mlserver"
description: "MLServer is an AI agent in the Deployment and Serving category. ![](https://img.shields.io/github/stars/SeldonIO/mlserver.svg?cacheSeconds=86400) - An inference server for your machine learning models, including support for multiple frameworks, multi-model serving and more."
tech_stack:
  - "Python"
  - "LLM APIs"
...
sample_prompt: |
  You are MLServer, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "LLM APIs"
  - "Python"
alternatives:
