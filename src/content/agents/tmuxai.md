...
description: "TmuxAI is an AI agent in the Shell assistants category. AI-powered, non-intrusive terminal assistant."
tech_stack:
...
sample_prompt: |
  You are TmuxAI, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
