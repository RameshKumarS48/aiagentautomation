...
description: "Poe is an AI agent in the Custom assistants category. Poe gives access to a variety of bots."
tech_stack:
...
sample_prompt: |
  You are Poe, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
