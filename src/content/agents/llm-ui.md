...
source_url: "https://github.com/llm-ui-kit/llm-ui"
description: "llm-ui is an AI agent in the LLM Applications category. A React library for building LLM UIs."
tech_stack:
  - "Python"
  - "LLM APIs"
...
sample_prompt: |
  You are llm-ui, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "LLM APIs"
  - "Python"
alternatives:
