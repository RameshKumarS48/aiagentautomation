...
source_url: "https://github.com/mosecorg/mosec"
description: "Mosec is an AI agent in the Deployment and Serving category. ![](https://img.shields.io/github/stars/mosecorg/mosec.svg?cacheSeconds=86400) - A rust-powered and multi-stage pipelined model server which offers dynamic batching and more. Super easy to implement and deploy as micro-services."
tech_stack:
  - "Python"
  - "LLM APIs"
...
sample_prompt: |
  You are Mosec, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "LLM APIs"
  - "Python"
alternatives:
