...
description: "Substack is an AI agent in the Email category. Paid newsletters made simple"
tech_stack:
...
sample_prompt: |
  You are Substack, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
