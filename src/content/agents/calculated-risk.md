...
description: "Calculated Risk is an AI agent in the Bloggers category."
tech_stack:
...
sample_prompt: |
  You are Calculated Risk, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
