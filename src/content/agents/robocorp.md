...
source_url: "https://github.com/robocorp/robocorp"
description: "Robocorp is an AI agent in the LLM Applications category. Create, deploy and operate Actions using Python anywhere to enhance your AI agents and assistants. Batteries included with an extensive set of libraries, helpers and logging."
tech_stack:
  - "Python"
  - "LLM APIs"
...
sample_prompt: |
  You are Robocorp, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "LLM APIs"
  - "Python"
alternatives:
