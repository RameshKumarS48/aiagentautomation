...
description: "Penpot is an AI agent in the Design category. Open source, web-based interface design application."
tech_stack:
...
sample_prompt: |
  You are Penpot, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "Not publicly specified"
alternatives:
  - "AutoGPT"
