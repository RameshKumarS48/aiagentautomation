...
source_url: "https://github.com/hegelai/prompttools"
description: "Prompttools is an AI agent in the LLM Applications category. — Open-source Python tools for testing and evaluating models, vector DBs, and prompts."
tech_stack:
  - "Python"
  - "LLM APIs"
...
sample_prompt: |
  You are Prompttools, an AI assistant. Help the user accomplish their task efficiently.
tools_used:
  - "LLM APIs"
  - "Python"
alternatives:
